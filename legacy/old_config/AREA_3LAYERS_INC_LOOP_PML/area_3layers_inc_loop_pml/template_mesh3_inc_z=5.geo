...
zg1 = -400;
zg2 = -(PML_BEGIN);
zg3 = -(PML_BEGIN + PML_WIDTH);
zg4 = -3000;

za0 = 0;
za2 = 280;
za3 = (PML_BEGIN);
za4 = (PML_BEGIN + PML_WIDTH);
za5 = 3000;
...
Plane Surface(42) = {41};
Surface Loop(43) = {36, 26, 38, 30, 42, 40, 18, 16, 22, 20, 6};
Volume(44) = {43};
...
Plane Surface(88) = {87};
Surface Loop(89) = {76, 82, 84, 86, 88, 26, 10};
Volume(90) = {89};
