#if !defined(GMRES_COMPLEX_DI_MKL_H_INCLUDED)
#define GMRES_COMPLEX_DI_MKL_H_INCLUDED
...
class GMRES_Complex_Di_MKL : public solver_interface<complex<double>, size_t>
{
public:
...
#endif // GMRES_COMPLEX_DI_MKL_H_INCLUDED
