...
void GMRES_Complex::init(const size_t * gi_s, const size_t * gj_s, const complex<double> * di_s,
...
complex<double> GMRES_Complex::dot_prod(const complex<double> * a, const complex<double> * b) const
{
...
double GMRES_Complex::dot_prod_self(const complex<double> * a) const
{
    double d_p = 0.0;
    for(size_t i = 0; i < n; i++)
    {
...
void GMRES_Complex::mul_matrix(const complex<double> * f, complex<double> * x) const
{
    for(size_t i = 0; i < n; i++)
    {
...
void GMRES_Complex::copy_vec(const complex<double> * f, complex<double> * x) const
{
    for(size_t i = 0; i < n; i++)
        x[i] = f[i];
}

bool GMRES_Complex::is_fpu_error(double x) const
{
    double y = x - x;
    return x != x || y != y;
}

void GMRES_Complex::solve(complex<double> * solution, const complex<double> * rp_s,
