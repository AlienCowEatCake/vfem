#if !defined GMRES_COMPLEX_H_INCLUDED
#define GMRES_COMPLEX_H_INCLUDED
...
class GMRES_Complex : public solver_interface<complex<double>, size_t>
{
public:
...
#endif // GMRES_COMPLEX_H_INCLUDED
