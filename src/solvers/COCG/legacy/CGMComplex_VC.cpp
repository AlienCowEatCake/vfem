...
void CGMComplex_VC::init(const size_t * gi_s, const size_t * gj_s, const complex<double> * di_s,
...
void CGMComplex_VC::solve(complex<double> * solution, const complex<double> * rp, double gamma, size_t max_iter)
{
    double eps = gamma;
