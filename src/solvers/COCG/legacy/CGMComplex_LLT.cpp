...
void CGMComplex_LLT::init(const size_t * gi_s, const size_t * gj_s, const complex<double> * di_s,
...
void CGMComplex_LLT::solve(complex<double> * solution, const complex<double> * rp_s, double eps, size_t max_iter)
{
    rp = rp_s;
