...
void COCG_Smooth_OpenMP::init(const size_t * gi_s, const size_t * gj_s, const complex<double> * di_s,
...
complex<double> COCG_Smooth_OpenMP::dot_prod_nocj(const complex<double> * a, const complex<double> * b) const
{
    double d_p_real = 0.0;
    double d_p_imag = 0.0;
...
double COCG_Smooth_OpenMP::dot_prod_self(const complex<double> * a) const
{
    double d_p = 0.0;
...
double COCG_Smooth_OpenMP::dot_prod_real(const complex<double> * a, const complex<double> * b) const
{
    double d_p = 0.0;
#pragma omp parallel for reduction(+ : d_p)
    for(omp_int i = 0; i < (omp_int)n; i++)
...
void COCG_Smooth_OpenMP::mul_matrix(const complex<double> * f, complex<double> * x) const
{
...
bool COCG_Smooth_OpenMP::is_fpu_error(double x) const
{
    double y = x - x;
    return x != x || y != y;
}

void COCG_Smooth_OpenMP::solve(complex<double> * solution, const complex<double> * rp_s,
