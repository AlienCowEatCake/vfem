...
void COCG_Di_Smooth_MKL::init(const size_t * gi_s, const size_t * gj_s, const complex<double> * di_s,
...
complex<double> COCG_Di_Smooth_MKL::dot_prod_nocj(const complex<double> * a, const complex<double> * b) const
{
...
double COCG_Di_Smooth_MKL::dot_prod_self(const complex<double> * a) const
{
    MKL_Complex16 * a1 = reinterpret_cast<MKL_Complex16 *>(const_cast<complex<double> *>(a));
...
double COCG_Di_Smooth_MKL::dot_prod_real(const complex<double> * a, const complex<double> * b) const
{
    double d_p = 0.0;
...
void COCG_Di_Smooth_MKL::mul_matrix(const complex<double> * f, complex<double> * x) const
{
...
bool COCG_Di_Smooth_MKL::is_fpu_error(double x) const
{
    double y = x - x;
    return x != x || y != y;
}

void COCG_Di_Smooth_MKL::solve(complex<double> * solution, const complex<double> * rp_s, double eps, size_t max_iter)
{
    eps *= eps;
...
COCG_Di_Smooth_MKL::COCG_Di_Smooth_MKL()
{
    numThreads = -1;
    if(numThreads <= 0)
    {
