#if !defined COCG_LDLT_SMOOTH_H_INCLUDED
#define COCG_LDLT_SMOOTH_H_INCLUDED
...
class COCG_LDLT_Smooth : public solver_interface<complex<double>, size_t>
{
public:
...
#endif // COCG_LDLT_SMOOTH_H_INCLUDED
