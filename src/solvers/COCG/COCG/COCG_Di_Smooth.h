#if !defined COCG_DI_SMOOTH_H_INCLUDED
#define COCG_DI_SMOOTH_H_INCLUDED
...
class COCG_Di_Smooth : public solver_interface<complex<double>, size_t>
{
public:
...
#endif // COCG_DI_SMOOTH_H_INCLUDED
