#if !defined(COCR_LLT_SMOOTH_H_INCLUDED)
#define COCR_LLT_SMOOTH_H_INCLUDED
...
class COCR_LLT_Smooth : public solver_interface<complex<double>, size_t>
{
public:
...
#endif // COCR_LLT_SMOOTH_H_INCLUDED
