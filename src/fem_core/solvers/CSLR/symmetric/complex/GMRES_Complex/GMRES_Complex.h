#if !defined(SOLVERS_CSLR_SYMMETRIC_COMPLEX_GMRES_H_INCLUDED)
#define SOLVERS_CSLR_SYMMETRIC_COMPLEX_GMRES_H_INCLUDED
...
/**
 * @brief Комплексный GMRES
 */
class GMRES_Complex : public symmetric_solver_interface<std::complex<double>, std::size_t>
{
public:
...
#endif // SOLVERS_CSLR_SYMMETRIC_COMPLEX_GMRES_H_INCLUDED
