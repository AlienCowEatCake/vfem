#if !defined(SOLVERS_CSLR_SYMMETRIC_COMPLEX_COCG_H_INCLUDED)
#define SOLVERS_CSLR_SYMMETRIC_COMPLEX_COCG_H_INCLUDED
 ...
 * @brief COCG
 */
class COCG : public symmetric_solver_interface<std::complex<double>, std::size_t>
{
public:
...
protected:
    ...
    std::complex<double> * m_r, * m_x0, * m_z, * m_p, * m_s;
...
#endif // SOLVERS_CSLR_SYMMETRIC_COMPLEX_COCG_H_INCLUDED
