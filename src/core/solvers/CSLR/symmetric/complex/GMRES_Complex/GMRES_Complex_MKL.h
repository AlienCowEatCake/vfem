#if !defined(SOLVERS_CSLR_SYMMETRIC_COMPLEX_GMRES_MKL_H_INCLUDED)
#define SOLVERS_CSLR_SYMMETRIC_COMPLEX_GMRES_MKL_H_INCLUDED
...
#endif // SOLVERS_CSLR_SYMMETRIC_COMPLEX_GMRES_MKL_H_INCLUDED
