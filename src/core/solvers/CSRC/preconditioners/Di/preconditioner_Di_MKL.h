#if !defined(SOLVERS_CSRC_PRECONDITIONERS_DI_MKL_H_INCLUDED)
#define SOLVERS_CSRC_PRECONDITIONERS_DI_MKL_H_INCLUDED
...
#endif // SOLVERS_CSRC_PRECONDITIONERS_DI_MKL_H_INCLUDED
