#if !defined(SOLVERS_CSRC_PRECONDITIONERS_LDLT_H_INCLUDED)
#define SOLVERS_CSRC_PRECONDITIONERS_LDLT_H_INCLUDED
...
#endif // SOLVERS_CSRC_PRECONDITIONERS_LDLT_H_INCLUDED
