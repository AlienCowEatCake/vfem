#if !defined(SOLVERS_CSRC_PRECONDITIONERS_INTERFACE_H_INCLUDED)
#define SOLVERS_CSRC_PRECONDITIONERS_INTERFACE_H_INCLUDED
...
#endif // SOLVERS_CSRC_PRECONDITIONERS_INTERFACE_H_INCLUDED
