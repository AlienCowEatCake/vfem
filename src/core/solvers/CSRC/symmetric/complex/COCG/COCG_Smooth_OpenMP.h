#if !defined(SOLVERS_CSRC_SYMMETRIC_COMPLEX_COCG_SMOOTH_OPENMP_H_INCLUDED)
#define SOLVERS_CSRC_SYMMETRIC_COMPLEX_COCG_SMOOTH_OPENMP_H_INCLUDED
...
#endif // SOLVERS_CSRC_SYMMETRIC_COMPLEX_COCG_SMOOTH_OPENMP_H_INCLUDED
