#if !defined(SOLVERS_CSRC_SYMMETRIC_COMPLEX_BICGSTAB_SMOOTH_H_INCLUDED)
#define SOLVERS_CSRC_SYMMETRIC_COMPLEX_BICGSTAB_SMOOTH_H_INCLUDED
...
#endif // SOLVERS_CSRC_SYMMETRIC_COMPLEX_BICGSTAB_SMOOTH_H_INCLUDED
