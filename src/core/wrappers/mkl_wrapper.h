...
namespace core { namespace wrappers { namespace mkl_stubs {
...
}}} // namespace core::wrappers::mkl_stubs

using namespace core::wrappers::mkl_stubs;

#endif

// *************************************************************************************************

namespace core { namespace wrappers { namespace mkl {
