...
namespace core { namespace wrappers { namespace omp_stubs {
...
}}} // namespace core::wrappers::omp_stubs

using namespace core::wrappers::omp_stubs;
...
namespace core { namespace wrappers { namespace omp {
