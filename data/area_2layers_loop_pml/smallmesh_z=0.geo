...
Point(21) = {x1, x1, za0, c1};
Point(22) = {-x1, x1, za0, c1};
Point(23) = {x1, -x1, za0, c1};
Point(24) = {-x1, -x1, za0, c1};
Line(21) = {22, 21};
Line(22) = {21, 23};
Line(23) = {23, 24};
Line(24) = {24, 22};
Line Loop(25) = {22, 23, 24, 21};
Plane Surface(26) = {5, 25};
...
Line(36) = {23, 27};
Line(37) = {28, 24};
Line Loop(41) = {21, 32, -25, -34};
Plane Surface(42) = {41};
Line Loop(45) = {37, 24, 34, -28};
Plane Surface(46) = {45};
Line Loop(49) = {36, 27, 37, -23};
Plane Surface(50) = {49};
Line Loop(53) = {32, 26, -36, -22};
Plane Surface(54) = {53};
Surface Loop(55) = {30, 54, 42, 46, 50, 26, 6};
Volume(56) = {55};
...
Surface Loop(141) = {140, 132, 130, 134, 136, 138, 30, 54, 42, 46, 50};
Volume(142) = {141};
