...
Line(523) = {510, 511};
Line(524) = {512, 513};
Line Loop(525) = {501, 502, 503, 504};
Plane Surface(526) = {525};
Line Loop(527) = {501, -511, 512, -505};
Plane Surface(528) = {527};
Line Loop(529) = {512, 506, 508, 510};
Plane Surface(530) = {529};
Line Loop(531) = {508, 509, 503, -507};
Plane Surface(532) = {531};
Line Loop(533) = {517, 524, -518, -523};
Plane Surface(534) = {533};
Line Loop(535) = {519, -520, -502};
Plane Surface(536) = {535};
Line Loop(537) = {519, 524, -521, 511};
Plane Surface(538) = {537};
Line Loop(539) = {522, -524, -520, -509};
Plane Surface(540) = {539};
Line Loop(541) = {510, 521, -522};
Plane Surface(542) = {541};
Line Loop(543) = {515, -516, -504};
Plane Surface(544) = {543};
Line Loop(545) = {516, 523, -513, -505};
Plane Surface(546) = {545};
Line Loop(547) = {515, 523, -514, 507};
Plane Surface(548) = {547};
Line Loop(549) = {514, -513, 506};
Plane Surface(550) = {549};
Line Loop(551) = {514, 518, -522, -508};
Plane Surface(552) = {551};
Line Loop(553) = {517, -520, 503, 515};
Plane Surface(554) = {553};
Line Loop(555) = {516, 517, -519, -501};
Plane Surface(556) = {555};
Line Loop(557) = {512, 513, 518, -521};
Plane Surface(558) = {557};
Surface Loop(559) = {526, 536, 544, 556, 554};
Volume(560) = {559};
Surface Loop(561) = {550, 530, 542, 552, 558};
Volume(562) = {561};
Surface Loop(563) = {546, 528, 538, 556, 558, 534};
Volume(564) = {563};
Surface Loop(565) = {532, 540, 548, 552, 534, 554};
Volume(566) = {565};
...
Plane Surface(42) = {41};
Surface Loop(43) = {26, 40, 38, 36, 42, 30, 526};
Volume(44) = {43};
...
Plane Surface(88) = {87};
Surface Loop(89) = {84, 76, 82, 88, 86, 26, 530, 550, 542, 528, 538, 546, 548, 532, 540, 544, 536};
Volume(90) = {89};
...
// Вода
Physical Volume(12) = {566, 560, 564, 562, 90, 170};
// Вода - PML
