...
// Ромбик, бывшая петля
Point(2) = {x0, 0, zl1, electrode_cl};
Point(3) = {0, x0, zl1, c00};
Point(4) = {-x0, 0, zl1, electrode_cl};
...
// Проекция ромбика на границу раздела сред
...
// Концы электродов
Point(15) = {x0, 0, zl1 + electrode_len, electrode_cl};
Point(16) = {-x0, 0, zl1 + electrode_len, electrode_cl};

// Линии электродов
Line(99925) = {16, 4};
Line(99926) = {2, 15};
Physical Line(1) = {99925};
Physical Line(2) = {99926};
...
Line(13) = {16, 9};
Line(14) = {3, 8};
Line Loop(15) = {8, -14, -3, -99925, 13};
Plane Surface(16) = {15};
Line Loop(17) = {13, -7, -12, 2, -99925};
Plane Surface(18) = {17};
Line Loop(19) = {1, 12, -6, -11, -99926};
Plane Surface(20) = {19};
Line Loop(21) = {11, -5, -14, 4, 99926};
Plane Surface(22) = {21};
Surface Loop(23) = {10, 16, 22, 20, 6, 18};
Volume(24) = {23};
