...
// Электрод 1
BASE = 500;
CENTER = {x0, 0, - electrode_len / 2.0};
SIZE = {electrode_len, electrode_len / 5};
COEFF = electrode_cl;
PHYSICAL = 1;
Merge "electrode.geo";
Line Loop(570) = {501, 502, 503, 504};
...
Plane Surface(42) = {41};
Surface Loop(43) = {36, 26, 40, 38, 30, 42, 634, 632, 636, 638, 534, 532, 538, 536};
Volume(44) = {43};
...
Plane Surface(88) = {87};
Surface Loop(89) = {84, 76, 82, 88, 86, 26, 616, 642, 618, 640, 620, 644, 622, 646, 516, 542, 522, 546, 520, 544, 518, 540};
Volume(90) = {89};
...
// Вода
Physical Volume(12) = {90, 170, 557, 559, 561, 563, 657, 659, 661, 663};
// Вода - PML
