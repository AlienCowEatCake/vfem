...
Point(25) = {x1, x1, za2, c2};
Point(26) = {-x1, x1, za2, c2};
Point(27) = {x1, -x1, za2, c2};
Point(28) = {-x1, -x1, za2, c2};
Line(25) = {26, 25};
Line(26) = {25, 27};
Line(27) = {27, 28};
Line(28) = {28, 26};
...
Point(71) = {x1, x1, zg2, c2};
Point(72) = {-x1, x1, zg2, c2};
Point(73) = {x1, -x1, zg2, c2};
Point(74) = {-x1, -x1, zg2, c2};
Line(71) = {72, 71};
Line(72) = {71, 73};
Line(73) = {73, 74};
Line(74) = {74, 72};
